...
@Directive({
  selector: `
    input:not([matAutocomplete]):not([type=checkbox]):not([type=radio]):not([type=password]):not([readonly]):not(.ng-trim-ignore):not([ssn-mask]):not([matDatepicker]):not([spMask]):not([currencyInput])[formControlName],
    input:not([matAutocomplete]):not([type=checkbox]):not([type=radio]):not([type=password]):not([readonly]):not(.ng-trim-ignore):not([ssn-mask]):not([matDatepicker]):not([spMask]):not([currencyInput])[formControl],
    input:not([matAutocomplete]):not([type=checkbox]):not([type=radio]):not([type=password]):not([readonly]):not(.ng-trim-ignore):not([ssn-mask]):not([matDatepicker]):not([spMask]):not([currencyInput])[ngModel],
